...
// Post-save middleware to update category article count
articleSchema.post("save", async function () {
  const Category = require("./Category");
  await Category.updateArticleCount(this.category);
});

// Post-remove middleware to update category article count
